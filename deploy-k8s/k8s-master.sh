...
images=( kubernetes-dashboard-amd64:v1.8.3 )
...
# kubeadm 初始化镜像
kubeadm init --kubernetes-version=v1.14.1 --pod-network-cidr=10.244.0.0/16 --image-repository registry.aliyuncs.com/google_containers
